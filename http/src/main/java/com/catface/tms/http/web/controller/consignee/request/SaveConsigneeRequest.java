 ...
 */
@Data
public class SaveConsigneeRequest {
  ...
  @ApiModelProperty(value = "收货人姓名", required = true, example = "佟掌柜")
  @NotBlank(message = "收货人姓名不能为空")
  private String consigneeName;

  @ApiModelProperty(value = "收货人手机号", required = true, example = "17767675656")
  @NotBlank(message = "收货人手机号不能为空")
  private String consigneeMobile;

  @ApiModelProperty(value = "收货人所在省份", required = true)
  @NotNull(message = "收货人所在省份不能为空")
  @Valid
  private ProvinceRequest province;

  @ApiModelProperty(value = "收货人所在城市", required = true)
  @NotNull(message = "收货人所在城市不能为空")
  @Valid
  private CityRequest city;

  @ApiModelProperty(value = "收货人所在县区", required = true)
  @NotNull(message = "收货人所在县区不能为空")
  @Valid
  private DistrictRequest district;

  @ApiModelProperty(value = "收货人所在街道", required = true)
  @NotNull(message = "收货人所在街道不能为空")
  @Valid
