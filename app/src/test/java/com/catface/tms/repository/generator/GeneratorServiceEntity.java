package com.catface.tms.repository.generator;
...
import com.catface.tms.BaseTest;
...
public class GeneratorServiceEntity extends BaseTest {
    ...
    private final String packageName = "com.catface.tms.repository";
    ...
    public void generateAllCode() {
        generateByTables(serviceNameStartWithI, packageName, "dispatch_order");
    }

    @Test
    public void generateOnlyEntity() {
        generateEntity(serviceNameStartWithI, packageName, "dispatch_order");
    }
